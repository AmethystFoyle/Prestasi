...
<head>
    ...
    <link rel="stylesheet" href="CSS/edit_profile_content_supplier.css">
</head>
<body>
    <div class = "main-container">
        ...
        <?php include 'HTML/Dashboard/Supplier/EditProfile/edit_profile_header_supplier.php'; ?>
        <?php include 'HTML/Dashboard/Supplier/EditProfile/edit_profile_content_supplier.php'; ?>
    </div>
