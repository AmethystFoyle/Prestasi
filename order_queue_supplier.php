...
<body>
    <div class = "main-container">
        ...
        <?php include 'PHP/Dashboard/Supplier/order_queue_content_supplier_php.php'; ?>

        <?php include 'HTML/Dashboard/Supplier/OrderQueue/order_queue_header_supplier.php'; ?>
        <?php include 'HTML/Dashboard/Supplier/OrderQueue/order_queue_content_supplier.php'; ?>
    </div>
