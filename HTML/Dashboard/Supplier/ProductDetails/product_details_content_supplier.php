...
<div class = "menu-content-supplier-add-new">
        <h4 id = "product_detail_supplier_add_new_title">Looks like you do not have any products. Please click the button below to add a new product.</h4>
        <a href = "add_item_supplier.php"><button class = "btn-single">Add New</button></a>
</div>