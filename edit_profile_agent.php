...
<head>
    ...
    <link rel="stylesheet" href="CSS/edit_profile_header_agent.css">
    <link rel="stylesheet" href="CSS/edit_profile_content_agent.css">
</head>
<body>
    <div class = "main-container">

        <!-- This is to get the agent's name and id -->
        <?php include 'PHP/LoginSignup/losi_content_php.php'; ?>

        <?php include 'HTML/Dashboard/Agent/EditProfile/edit_profile_header_agent.php'; ?>
        <?php include 'HTML/Dashboard/Agent/EditProfile/edit_profile_content_agent.php'; ?>
    </div>
